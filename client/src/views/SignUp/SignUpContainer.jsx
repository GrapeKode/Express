...
export default (props) => {
  ...
  if (props.submitError) {
    ...
    submitInfo = <div className="alert alert-success alert-dismissible">Signup successfully</div>
  }
        ...
        <div className="col-md-7 flex-center">
          <form onSubmit={props.handleSignUp}>
            ...
            <div className="custom-control custom-switch text-left mb-3">
              <input type="checkbox" name="policy" className="custom-control-input" id="remember" checked={props.values.policy} onChange={props.handleFieldChange} />
              <label className="custom-control-label" htmlFor="remember">
                I have read the <a href="#Terms&Conditions">Terms and Conditions</a>
              </label>
            </div>
            {submitButton}
